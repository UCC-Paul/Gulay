      ...
      <div class = "card">
        ...
        <div class = "product-imgs">
          ...
          <div class = "img-select">
            <div class = "img-item">
              <a href = "#" data-id = "1">
                <img src = "../img/vegetables/tomato/tomato (9).jpg" alt = "" style="height: 100px;">
              </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "2">
                <img src = "../img/vegetables/tomato/tomato (8).jpg" alt = "" style="height: 100px;">
              </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "3">
                <img src = "../img/vegetables/tomato/tomato (6).jpg" alt = "" style="height: 100px;">
              </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "4">
                <img src = "../img/vegetables/tomato/tomato (7).jpg" alt = "" style="height: 100px;">
              </a>
            </div>
          </div>
        </div>
