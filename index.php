...
<body>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    ...
                                    <a href="gallery.php" class="btn btn-primary rounded-pill py-sm-3 px-sm-5">Vegetables</a>
                                    <a href="ai.php" class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">Services</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">To educate people who wants to start planting</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">To maximize soil type and quality for the best vegetable product.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">Promote zero insecticides and reduce carbon Emission.</p>
    ...
    <!-- Product Start -->
    <?php include 'components/galleryinclude.php'; ?>
    <!-- Product End -->
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-md-7 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="display-5 text-white mb-3">Try our AI Soil Identifier and Smart Crop Recommendations</h1>
